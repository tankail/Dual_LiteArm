#!/usr/bin/env python3
"""Joint interpolation demo with zero commanded velocity."""
...
def main():
    parser = argparse.ArgumentParser(description="Zero-velocity joint interpolation.")
    ...
    try:
        ...
        if not args.execute:
            ...
            return
        interpolate_arm(robot, args.side, q0, q1, args.duration, zero_velocity=True)
