...
export class FileHandler {
    ...
    async loadFromServer(_baseUrl, fileList) {
        try {
            ...
            // Prefer LiteArm URDFs, then Panthera, then any URDF
            urdfPath = urdfFiles.find(p => p.includes('LiteArm_A10_251125')) ||
                       urdfFiles.find(p => p.includes('LiteArm')) ||
                       urdfFiles.find(p => p.includes('Panthera-HT_description_with_finger')) ||
