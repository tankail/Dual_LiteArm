#!/usr/bin/env python3
"""Keyboard Cartesian position control for the right LiteArm."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Keyboard Cartesian position control for the right LiteArm."
    )
    parser.add_argument(
        "--config",
...
def main():
    ...
    try:
        ...
        print("=" * 64)
        print("LiteArm right-arm keyboard Cartesian position control")
        print("=" * 64)
        ...
        print("Only right-arm motor IDs 9-15 receive commands.")
        ...
        print("\nRight-arm Cartesian controller stopped.")
